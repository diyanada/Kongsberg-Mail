...
echo html_tag( 'table',
    html_tag( 'tr',
        html_tag( 'td',
            ...
            '<small>Kongsberg-Reports MailServer<br /></small>' . "\n" ) .
            html_tag( 'table width="540"',
                html_tag( 'tr',
                    html_tag( 'td',
                    ...
                    html_tag( 'td',  "\n" .
                        html_tag( 'table',
                            html_tag( 'tr',
                                ...
                                'right', '', 'width="200px"' ) .
                                html_tag( 'td',
				    addInput($username_form_name, $loginname_value, 0, 0, ' onfocus="alreadyFocused=true; " style="width:340px;height:30px"'),
                                'left', '', '' )
                                ) . "\n" .
                            html_tag( 'tr',
                                html_tag( 'td',
                                ...
                                'right', '', 'width="200px"' ) .
                                html_tag( 'td',
				    addPwField($password_form_name, null, ' onfocus="alreadyFocused=true;" style="width:340px;height:30px"').
				    addHidden('js_autodetect_results', SMPREF_JS_OFF).
                    $mailtofield . 
				    addHidden('just_logged_in', '1'),
                                'left', '', '' )
                            ) ,
                        'center', $color[4], 'border="0" frame="box" width="100%"' ) ,
                    'left',$color[4] )
                ) . 
                html_tag( 'tr',
                    html_tag( 'td',
